namespace StockMate.Forms.Borrowers
{
    partial class frmAddBorrower
    {
        ...
        private void InitializeComponent()
        {
            ...
            autoLabel1.Text = "Enter the details of the borrower to add to your inventory.";
            // 
            // btnAddProduct
            // 
            ...
            cmbCategory.DropDownStyle = Syncfusion.WinForms.ListView.Enums.DropDownStyle.DropDownList;
            ...
            cmbSupplier.DropDownStyle = Syncfusion.WinForms.ListView.Enums.DropDownStyle.DropDownList;
